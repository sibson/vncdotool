...
[RFC 6143](https://www.rfc-editor.org/rfc/rfc6143) is the normative specification. It defines RFB 3.8 and the
encodings and security types that shipped with it, and it is the one to
cite when the wire format is in dispute.

[rfbproto](https://github.com/rfbproto/rfbproto/blob/master/rfbproto.rst) is a community effort to document everything servers grew
